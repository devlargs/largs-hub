...
export default function AddServiceModal({
  ...
  // While the cropper is open it owns both — Escape should back out of the crop,
  // not throw away the whole form behind it.
  ...
  return (
    <>
      ...
      {/* Outside the backdrop above, whose click handler closes the whole form. */}
      {cropSource && (
        <IconCropper
          source={cropSource}
