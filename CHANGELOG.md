...
- **Behind the scenes: the largest files split into smaller pieces.** The Messenger automation panel, the Settings page, the Add service dialog and the app shell were broken into focused parts, and their form, update-status, add-service and keyboard-shortcut logic now has automated tests. Nothing should look or behave differently on Windows or macOS.
