...
- **Behind the scenes: the largest files split into smaller pieces.** The Messenger automation panel and the Settings page were broken into focused parts, and their form and update-status logic now has automated tests. Nothing should look or behave differently on Windows or macOS.
