...
- **Behind the scenes: the largest files split into smaller pieces.** The Messenger automation panel, the Settings page and the Add service dialog were broken into focused parts, and their form, update-status and add-service logic now has automated tests. Nothing should look or behave differently on Windows or macOS.
