...
- **Behind the scenes: the largest files split into smaller pieces.** The Messenger automation panel was broken into focused parts, and its form logic now has automated tests. Nothing should look or behave differently on Windows or macOS.
